...
$BACK_PATH = '../../../../typo3/';
define('TYPO3_MOD_PATH', '../typo3conf/ext/tako_qype/wizard/');


// by RICC
if (!ereg('typo3conf', $_SERVER['PHP_SELF'])) {
  $BACK_PATH = '../../../';
  define('TYPO3_MOD_PATH', 'ext/tako_qype/wizard/');
} else {
  $BACK_PATH = '../../../../typo3/';
  define('TYPO3_MOD_PATH', '../typo3conf/ext/tako_qype/wizard/');
}
...
$MCONF['name']='xMOD_tx_takoqype_wizard';
$MCONF['script']='index.php';

require_once ($BACK_PATH.'init.php');
require_once ($BACK_PATH.'template.php');
require_once (PATH_t3lib.'class.t3lib_scbase.php');
$LANG->includeLLFile('EXT:tako_qype/wizard/locallang.xml');
...
class tx_takoqype_wizard extends t3lib_SCbase {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tako_qype/wizard/index.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tako_qype/wizard/index.php']);
}

// Make instance:
$SOBE = t3lib_div::makeInstance('tx_takoqype_wizard');
$SOBE->init();
