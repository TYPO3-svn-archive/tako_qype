...
class tx_takoqype_tca  {
	 ...
	 */
  function user_takoqypedescr ($PA, $fobj) {
		// set the correct path, needed for global installation, thx Clemens
    $this->correctWizardPath = t3lib_extMgm::extRelPath('tako_qype') . "wizard/";
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tako_qype/lib/class.tx_takoqype_tca.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tako_qype/lib/class.tx_tako_jqgalerietca.php']);
}
